...
./configure.py --prefix=/opt/local --with-commoncrypto --with-os-features=security_framework,commoncrypto,getentropy --with-openssl --with-lzma --with-bzip2 --with-zlib --with-sqlite3 --with-python-version=2.7 --with-sphinx --with-pdf --cc-abi-flags='-maes -mpclmul -mrdrnd -msse2 -mssse3 -msse4 -msse4.2 -Os -Ofast -I/opt/local/include' 2>&1 | tee conf-out.txt
